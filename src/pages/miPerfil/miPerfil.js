function MiPerfil() {
	return (
		<>
			<body className="min-h-screen flex items-center justify-center p-4"></body>
			<h1 className="text-3xl font-bold">Mi Perfil</h1>
			<div className="bg-white dark:bg-gray-500/50 rounded-xl shadow-2xl w-full p-8 transition-all duration-300 animate-fade-in">
